...
export const ResponseSection = ({ responses, index, onClick }) => {

  return (
    <div onClick={() => onClick()} className="px-6 mb-4 w-full rounded-full border bg-[#606466] cursor-pointer flex justify-between">
